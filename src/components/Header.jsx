export default function Header() {
  return (
    <header
      className="fixed w-full z-[1] top-0 bg-white flex items-center justify-center py-[24px] 
    ...
    >
      <div className="w-full mx-auto flex items-center justify-center lg:justify-start lg:ml-[100px]">
        <a href="/" aria-label="Herself Health home" className="flex items-center">
          <img src="/images/logo.svg" alt="Herself Health logo" className="h-auto w-auto" />
